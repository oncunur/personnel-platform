...
public sealed record MeResponse(Guid UserId, string Username, string? Email, int SecurityVersion, IReadOnlyList<RoleSummary> Roles, IReadOnlyList<PermissionSummary> Permissions, IReadOnlyList<ScopeSummary> Scopes);
