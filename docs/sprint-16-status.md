...
| MIG-002 | Field mapping & transformation rules | PLANNED | Field-level mappings, code/value dictionaries, key strategy, validation rules |
...
MIG-001 defines what exists and where it should land. It does **not** yet authorize loading production data. Source extracts, field mappings, transformation rules, dry-run tooling and business reconciliation must be completed in the following migration items.
